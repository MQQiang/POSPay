...
#define HYSegmentedControl_Height 48.0
#define LYSegmentedControl_ImageEdgeInset 9
...
- (id)initWithOriginY:(CGFloat)y Number:(NSInteger)numberOfSengment delegate:(id)delegate
{
    ...
    if (self = [super initWithFrame:rect4View]) {
        ...
        self.numberOfSegment = numberOfSengment;
        self.delegate = delegate;
        
        //
        //  array4btn
        //
        _array4Btn = [[NSMutableArray alloc] initWithCapacity:numberOfSengment];
        
        //
        //  set button
        //
        CGFloat width4btn = rect4View.size.width/numberOfSengment;
        ...
        _scrollView.contentSize = CGSizeMake(numberOfSengment*width4btn, HYSegmentedControl_Height);
        _scrollView.showsHorizontalScrollIndicator = NO;
        
        for (int i = 0; i<numberOfSengment; i++) {
            ...
            switch (i) {
                case 0:
                    [btn setImage:[UIImage imageNamed:@"选项卡（小）1"] forState:UIControlStateNormal];
                    break;
                case 1:
                    [btn setImage:[UIImage imageNamed:@"选项卡（小）2"] forState:UIControlStateNormal];
                    break;
                case 2:
                    [btn setImage:[UIImage imageNamed:@"选项卡（小）3"] forState:UIControlStateNormal];
                    break;
                case 3:
                    [btn setImage:[UIImage imageNamed:@"选项卡（小）4"] forState:UIControlStateNormal];
                    break;
                default:
                    break;
            }
            [btn setImageEdgeInsets:UIEdgeInsetsMake(LYSegmentedControl_ImageEdgeInset,LYSegmentedControl_ImageEdgeInset,LYSegmentedControl_ImageEdgeInset,LYSegmentedControl_ImageEdgeInset)];
        ...
        //  lineView
        //
        CGFloat height4Line = HYSegmentedControl_Height/2.0f;
        CGFloat originY = (HYSegmentedControl_Height - height4Line)/2;
        for (int i = 1; i<numberOfSengment; i++) {
        ...
        //  bottom lineView
        //
        _bottomLineView = [[UIView alloc] initWithFrame:CGRectMake(5.0f, HYSegmentedControl_Height-3, width4btn-10.0f, 3.0f)];
...
{
//    if (index > self.numberOfSegment-1) {
//        NSLog(@"index 超出范围");
